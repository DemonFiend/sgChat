...
ALTER TABLE role_reaction_mappings
  ADD COLUMN IF NOT EXISTS emoji_type TEXT NOT NULL DEFAULT 'unicode' CHECK (emoji_type IN ('unicode', 'custom')),
  ADD COLUMN IF NOT EXISTS custom_emoji_id UUID REFERENCES emojis(id) ON DELETE SET NULL;
