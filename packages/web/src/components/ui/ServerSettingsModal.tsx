          ...
          <div className="max-w-[740px] mx-auto">
            {isLoading ? (
              ...
              <>
                ...
                {activeTab === 'roles' && <RolesTab serverId={serverData?.id || ''} serverOwnerId={serverOwnerId} onCloseModal={onClose} />}
...
function RolesTab({ serverId, serverOwnerId, onCloseModal }: { serverId: string; serverOwnerId?: string; onCloseModal: () => void }) {
        ...
        {selectedRole ? (
          <>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              {(permissions.isAdmin() || permissions.isOwner(serverOwnerId)) && serverId && (
                <button
                  onClick={() => {
                    useImpersonationStore.getState().activate(
                      serverId,
                      [selectedRole.id],
                      roles
                    );
                  ...
                  title="Preview server as this role"
                >
                  <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
