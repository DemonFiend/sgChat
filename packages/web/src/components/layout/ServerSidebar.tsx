...
export function ServerSidebar(props: ServerSidebarProps) {
  ...
  return (
    <div class="flex flex-col w-60 h-full bg-bg-secondary border-r border-bg-tertiary">
      {/* Header with Logout and Server Icon */}
      <div class="flex items-center gap-2 p-3 border-b border-bg-tertiary">
        ...
        {/* Server Icon */}
        <Show 
          when={props.onServerSettingsClick}
          fallback={
            <div class="flex-1 flex items-center gap-3 p-2">
        ...
        >
          ...
          >
            ...
            <div class="flex-1 min-w-0 text-left">
              ...
              <div class="text-xs text-text-muted">Click to manage</div>
            </div>
            <svg class="w-4 h-4 text-text-muted group-hover:text-text-primary transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
